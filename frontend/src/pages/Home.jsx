  ...
  return (
    <div className="App" data-testid="axum-app">
      ...
      <main
        id="top"
        tabIndex={-1}
        className="pt-[108px] pb-[calc(50px+env(safe-area-inset-bottom,0px))] md:pb-0 focus:outline-none"
      >
        ...
        <section id="shop" tabIndex={-1} className="axum-border-t scroll-mt-[108px] focus:outline-none">
          <ProductGrid />
        </section>
        <CategoryBlocks />
